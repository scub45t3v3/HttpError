...
describe('ServiceUnavailable', () => {
  ...
  it('should return an instance of ServiceUnavailable', () => {
    unit
  ...
  it('should return an instaceof ServiceUnavailable without the new operator', () => {
    unit
  ...
  describe('#toString', () => {
    ...
    it('should return ServiceUnavailable: 503 Service Unavailable', () => {
      const test = new ServiceUnavailable();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/serviceunavailable"', () => {
      const test = new ServiceUnavailable();
...
}); // end describe ServiceUnavailable
...
describe('NotAcceptable', () => {
  ...
  it('should return an instance of NotAcceptable', () => {
    unit
  ...
  it('should return an instaceof NotAcceptable without the new operator', () => {
    unit
  ...
  describe('#toString', () => {
    ...
    it('should return NotAcceptable: 406 Not Acceptable', () => {
      const test = new NotAcceptable();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/notacceptable"', () => {
      const test = new NotAcceptable();

...
describe('IMATeapot', () => {
  ...
  it('should return an instance of IMATeapot', () => {
    unit
  ...
  it('should return an instaceof IMATeapot without the new operator', () => {
    unit
      .object(IMATeapot())
      .isInstanceOf(IMATeapot)
      .isEnumerable('code', 418)
  ...
  describe('#toString', () => {
    ...
    it('should return IMATeapot: 418 I\'m a teapot', () => {
      const test = new IMATeapot();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/imateapot"', () => {
      const test = new IMATeapot();

...
describe('Conflict', () => {
  ...
  it('should return an instance of Conflict', () => {
    unit
      .object(new Conflict())
  ...
  it('should return an instaceof Conflict without the new operator', () => {
    unit
      .object(Conflict())
      .isInstanceOf(Conflict)
      .isEnumerable('code', 409)
  ...
  describe('#toString', () => {
    ...
    it('should return Conflict: 409 Conflict', () => {
      const test = new Conflict();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/conflict"', () => {
      const test = new Conflict();

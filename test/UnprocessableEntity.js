...
describe('UnprocessableEntity', () => {
  ...
  it('should return an instance of UnprocessableEntity', () => {
    unit
  ...
  it('should return an instaceof UnprocessableEntity without the new operator', () => {
    unit
  ...
  describe('#toString', () => {
    ...
    it('should return UnprocessableEntity: 422 Unprocessable Entity', () => {
      const test = new UnprocessableEntity();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/unprocessableentity"', () => {
      const test = new UnprocessableEntity();
...
}); // end describe UnprocessableEntity
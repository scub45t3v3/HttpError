...
describe('UnknownError', () => {
  ...
  it('should return an instance of UnknownError', () => {
    unit
  ...
  it('should return an instaceof UnknownError without the new operator', () => {
    unit
      .object(UnknownError())
      .isInstanceOf(UnknownError)
      .isEnumerable('code', 520)
  ...
  describe('#toString', () => {
    ...
    it('should return UnknownError: 520 Unknown Error', () => {
      const test = new UnknownError();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/unknownerror"', () => {
      const test = new UnknownError();

...
describe('UnsupportedMediaType', () => {
  ...
  it('should return an instance of UnsupportedMediaType', () => {
    unit
  ...
  it('should return an instaceof UnsupportedMediaType without the new operator', () => {
    unit
  ...
  describe('#toString', () => {
    ...
    it('should return UnsupportedMediaType: 415 Unsupported Media Type', () => {
      const test = new UnsupportedMediaType();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/unsupportedmediatype"', () => {
      const test = new UnsupportedMediaType();
...
}); // end describe UnsupportedMediaType
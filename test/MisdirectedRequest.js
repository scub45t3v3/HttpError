...
describe('MisdirectedRequest', () => {
  ...
  it('should return an instance of MisdirectedRequest', () => {
    unit
  ...
  it('should return an instaceof MisdirectedRequest without the new operator', () => {
    unit
  ...
  describe('#toString', () => {
    ...
    it('should return MisdirectedRequest: 421 Misdirected Request', () => {
      const test = new MisdirectedRequest();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/misdirectedrequest"', () => {
      const test = new MisdirectedRequest();
...
}); // end describe MisdirectedRequest
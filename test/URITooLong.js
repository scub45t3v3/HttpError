...
describe('URITooLong', () => {
  ...
  it('should return an instance of URITooLong', () => {
    unit
  ...
  it('should return an instaceof URITooLong without the new operator', () => {
    unit
      .object(URITooLong())
      .isInstanceOf(URITooLong)
      .isEnumerable('code', 414)
  ...
  describe('#toString', () => {
    ...
    it('should return URITooLong: 414 URI Too Long', () => {
      const test = new URITooLong();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/uritoolong"', () => {
      const test = new URITooLong();

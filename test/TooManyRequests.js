...
describe('TooManyRequests', () => {
  ...
  it('should return an instance of TooManyRequests', () => {
    unit
  ...
  it('should return an instaceof TooManyRequests without the new operator', () => {
    unit
  ...
  describe('#toString', () => {
    ...
    it('should return TooManyRequests: 429 Too Many Requests', () => {
      const test = new TooManyRequests();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/toomanyrequests"', () => {
      const test = new TooManyRequests();

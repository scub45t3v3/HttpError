...
describe('NotFound', () => {
  ...
  it('should return an instance of NotFound', () => {
    unit
      .object(new NotFound())
  ...
  it('should return an instaceof NotFound without the new operator', () => {
    unit
      .object(NotFound())
      .isInstanceOf(NotFound)
      .isEnumerable('code', 404)
  ...
  describe('#toString', () => {
    ...
    it('should return NotFound: 404 Not Found', () => {
      const test = new NotFound();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/notfound"', () => {
      const test = new NotFound();

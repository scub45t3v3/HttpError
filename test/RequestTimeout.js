...
describe('RequestTimeout', () => {
  ...
  it('should return an instance of RequestTimeout', () => {
    unit
  ...
  it('should return an instaceof RequestTimeout without the new operator', () => {
    unit
  ...
  describe('#toString', () => {
    ...
    it('should return RequestTimeout: 408 Request Timeout', () => {
      const test = new RequestTimeout();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/requesttimeout"', () => {
      const test = new RequestTimeout();

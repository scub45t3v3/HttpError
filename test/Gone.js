...
describe('Gone', () => {
  ...
  it('should return an instance of Gone', () => {
    unit
      .object(new Gone())
      .isInstanceOf(Gone)
  ...
  it('should return an instaceof Gone without the new operator', () => {
    unit
      .object(Gone())
      .isInstanceOf(Gone)
      .isEnumerable('code', 410)
  ...
  describe('#toString', () => {
    ...
    it('should return Gone: 410 Gone', () => {
      const test = new Gone();
  ...
  describe('#[Symbol.toStringTag]', () => {
    it('should return "@scuba-squad/gone"', () => {
      const test = new Gone();
